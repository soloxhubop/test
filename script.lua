...
win.Size = UDim2.new(0, 460, 0, 530)
win.Position = UDim2.new(0.5, -230, 0.5, -265)
...
local closeHeaderBtn = makeHeaderBtn("âœ•", -10, Color3.fromRGB(200, 50, 50))
makeHeaderBtn("â˜…", -46, Color3.fromRGB(60, 60, 60))
...
supportLbl.Text = "â€¢ Need support?  Join Discord"
...
getKeyLbl.Text = "â€¢ â€¢  Click a button below to get your key"
...
if _LocalPlayer.UserId == ADMIN_ID then
    ...
    adminBtn.Text = "âš¡ Genera Key (Admin)"
    ...
    adminBtn.MouseButton1Click:Connect(function()
        ...
        adminBtn.Text = "âœ” Inviata su Discord!"
...
local function showTpPicker()
    ...
    makePickBtn("Ã¢â€”â‚¬ TP LEFT", 10, "LEFT")
    makePickBtn("TP RIGHT Ã¢â€“Â¶", 130, "RIGHT")
...
local function buildMenuPanel()
    ...
    -- [[ SPEED WHILE STEALING input Ã¢â‚¬â€ controls steal speed + auto return speed ]] --
...
local function tryRedeem(inputKey)
    ...
    if valid then
        ...
        statusLbl.Text = "âœ” Key valida! Caricamento..."
        ...
        redeemBtn.Text = "â€º Redeem"
        redeemBtn.BackgroundColor3 = Color3.fromRGB(110, 40, 220)
        statusLbl.Text = "âœ˜ Key non valida o scaduta!"
